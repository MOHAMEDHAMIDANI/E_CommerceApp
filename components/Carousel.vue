<template>
    <div id="carousel" class="scroll-smooth relative h-full mb-1 w-fit container mx-auto mt-2 ">
        <div @click="MoveToTheLeft()"  class="absolute w-7 h-full flex  top-0 -left-8 sm: z-10 hover:bg-white rounded-s-md shadow duration-500 cursor-pointer">
